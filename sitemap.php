...
<h2 style="text-align: center; margin-top: 20px"><?php bloginfo('name'); ?>的站点地图</h2>
<center></center>
...
<center>
<div style="text-algin: center; font-size: 11px">折耳猫在<?php $last = $wpdb->get_results("SELECT MAX(post_modified) AS MAX_m FROM $wpdb->posts WHERE (post_type = 'post' OR post_type = 'page') AND (post_status = 'publish' OR post_status = 'private')");$last = date('Y-m-d G:i:s', strtotime($last[0]->MAX_m));echo $last; ?>进行最后更新<br /><br /></div>
</center>
</body>
</html>