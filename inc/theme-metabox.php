...
if ( !class_exists('myCustomFields') ) {
    ...
    class myCustomFields {
        /**
        * @var  string  $prefix  自定义栏目前缀，一个完整的自定义栏目是需要前缀+name的，比如我的前缀是wyzblog_,name下面有baidu_submit，那么完整的自定义栏目就是wyzblog_baidu_submit.
        */
        var $prefix = 'wyzblog_';
        /**
        ...
        */
        function createCustomFields() {
            if ( function_exists( 'add_meta_box' ) ) {
                foreach ( $this->postTypes as $postType ) {
                    add_meta_box( 'my-custom-fields', '主题文章发布选项', array( $this, 'displayCustomFields' ), $postType, 'normal', 'high' );
                }
            }
        }
        /**
